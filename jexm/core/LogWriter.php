<?php
	...
	*/
	class LogWriter{
		...
		*/
		public static function writeLog($logMessage, $filename = "jexmlog"){
			$logfile = self::replaceCharsConcat($filename);
			$errorLog = self::createLog($logMessage);
		...
		*/
		private static function replaceCharsConcat($filename){
		...
		*/
		private static function createLog($logMessage){
